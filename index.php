				...
				foreach( $subsites as $subsite ) {
					...
					if($count>1){
						...
						$resultado = str_replace("/", "", $caena);
				 		?>
						<option label="<?php echo "$resultado" ?>" data-back="<?php echo bloginfo('url')."/wp-content/themes/agregala-site/img/flat_".$resultado.".png" ?>" value="<?php echo bloginfo('url').$subsite->path; ?>">
